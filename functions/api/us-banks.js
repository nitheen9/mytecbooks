    ...
    try {
        ...
        */
        ...
        if (type === "banks") {
            ...
            This prevents normal direct URL access.
            */
            ...
            const validReferer =
                referer.startsWith(
                    allowedOrigin + "/us-bank-finder"
                ) ||
                referer.startsWith(
                    allowedOrigin + "/us-bank-finder.html"
                );
